                    ...
                    <div class="container">
                        ...
                        <div class="ticket airline">
                            ...
                            <div class="bottom">
                                <div class="column">
                                    <div class="row row-1">
                                        <p><span>Trip</span>00{{$ticket->trip_id}}</p>
                                        <p class="row--right"><span></span></p>
                                    </div>
                                    <div class="row row-2">
                                        <p><span>Boards</span>10:25 AM</p>
                                        <p class="row--center"><span>Departs</span>{{$route->start_date}}</p>
                                        <p class="row--right"><span>Arrives</span>{{$route->estimated_date}}</p>
                                    </div>
                                    <div class="row row-3">
                                     
                                        <p class="row--center"><span>Bus Company</span>
                                            {{App\Models\company::where('id',$route->company_id)->value('name')}}
                                        
                                        </p>
                                        <p class="row--right"><span>Level</span>
                                ...
                                <div class="" style="display: flex;    justify-content: center;"><img src="data:image/png;base64,{{ base64_encode($ticket->barcode) }}" height="50px" width="50px" alt=""></div>
